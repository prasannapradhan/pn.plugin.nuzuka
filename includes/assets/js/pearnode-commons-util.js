...
function showProcessingLoader(msg){
	Swal.fire({title: msg, text: "Please wait...", imageUrl: "https://static-158c3.kxcdn.com/images/ajax-loader.gif", showConfirmButton:false, allowEscapeKey: false, allowOutsideClick: false});
}
