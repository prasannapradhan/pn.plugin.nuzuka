...
function toggleGroupDetails(icode){
	if($('#item_grp_row_' + icode).is(':visible')){
		...
		$('#item_grp_img_' + icode).attr("src", "https://static-158c3.kxcdn.com/images/pushdown.png");
	}else {
		NProgress.start();
...
function renderGroupMedia(icode){
	...
	$.get(url, function(data, status){
		...
		$('#grp_img_' + icode).attr("src", "https://static-158c3.kxcdn.com/images/pushup.png");
		NProgress.done();
	});
}
...
function toggleItemDetails(icode){
	if($('#item_details_row_' + icode).is(':visible')){
		...
		$('#item_details_img_' + icode).attr("src", "https://static-158c3.kxcdn.com/images/pushdown.png");
	}else {
		NProgress.start();
...
function renderItemMedia(icode){
	...
	$.get(url, function(data, status){
		...
		$('#item_details_img_' + icode).attr("src", "https://static-158c3.kxcdn.com/images/pushup.png");
		NProgress.done();
	});
}
