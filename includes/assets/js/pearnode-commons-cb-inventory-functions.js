...
function toggleGroupDetails(icode){
	if($('#item_grp_row_' + icode).is(':visible')){
		...
		$('#item_grp_img_' + icode).attr("src", "<?php echo plugin_dir_url( __DIR__ ).'includes/assets/'; ?>images/pushdown.png");
	}else {
		NProgress.start();
...
function renderGroupMedia(icode){
	...
	$.get(url, function(data, status){
		...
		$('#grp_img_' + icode).attr("src", "<?php echo plugin_dir_url( __DIR__ ).'includes/assets/'; ?>images/pushup.png");
		NProgress.done();
	});
}
...
function toggleItemDetails(icode){
	if($('#item_details_row_' + icode).is(':visible')){
		...
		$('#item_details_img_' + icode).attr("src", "<?php echo plugin_dir_url( __DIR__ ).'includes/assets/'; ?>images/pushdown.png");
	}else {
		NProgress.start();
...
function renderItemMedia(icode){
	...
	$.get(url, function(data, status){
		...
		$('#item_details_img_' + icode).attr("src", "<?php echo plugin_dir_url( __DIR__ ).'includes/assets/'; ?>images/pushup.png");
		NProgress.done();
	});
}
