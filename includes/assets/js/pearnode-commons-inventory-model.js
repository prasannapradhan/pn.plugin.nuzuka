class Item {
	constructor(iobj){
		...
		if (typeof this.g_img_url == 'undefined') {
			this.g_img_url = '<?php echo plugin_dir_url( __FILE__ ).'includes/assets/'; ?>images/group.png';	
		}
		if (typeof this.img_url == 'undefined') {
			this.img_url = '<?php echo plugin_dir_url( __FILE__ ).'includes/assets/'; ?>images/item.png';	
