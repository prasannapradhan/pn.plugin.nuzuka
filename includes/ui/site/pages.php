...
<head>
	...
	<script src="https://static-158c3.kxcdn.com/tools/chartjs/3.4.1/dist/chart.min.js" type="text/javascript" ></script>
    <script src="https://code.jquery.com/color/jquery.color-2.2.0.js"></script>
	<script src="https://static-158c3.kxcdn.com/tools/underscore/1.9.1/underscore-min.js" type="text/javascript"></script>
				...
				<div class="col-3 p-1 d-flex justify-content-end" style="font-size: 13px;">
					<div class="btn-group" role="group">
						...
						<button class="btn btn-sm btn-outline-secondary" onclick="return displayPageListing();" id="refresh_site_btn"
							...
							<img src="https://static-158c3.kxcdn.com/images/refresh.png" style="max-width:1.4vw"/>
						</button>
						<button class="btn btn-sm btn-outline-secondary" onclick="return displayPageListing();"
							...
							<img src="https://static-158c3.kxcdn.com/images/list.png" style="max-width:1.4vw"/>
						</button>
