				...
				<div class="card-footer">
					<div class="row d-flex justify-content-center">
						<button class="btn btn-sm btn-light" onclick="return enableWidget({{site_ref}}, {{id}});"
							...
							<img src="<?php echo plugins_url('includes/assets/', dirname(__FILE__)); ?>images/z.png" style="max-width:1.4vw;max-height:2.0vh;"/>
						</button>
						<button class="btn btn-sm btn-light" onclick="return inactivatePage({{id}})"
							...
							<img src="<?php echo plugins_url('includes/assets/', dirname(__FILE__)); ?>images/bin.png" style="max-width:1.4vw"/>
						</button>
					</div>
				</div>
			</div>
				...
				<div class="col-3 p-1 d-flex justify-content-end" style="font-size: 13px;">
					<div class="btn-group" role="group">
						...
						<button class="btn btn-sm btn-outline-secondary" onclick="return displayPageListing();" id="refresh_site_btn"
							...
							<img src="<?php echo plugins_url('includes/assets/', dirname(__FILE__)); ?>images/refresh.png" style="max-width:1.4vw"/>
						</button>
						<button class="btn btn-sm btn-outline-secondary" onclick="return displayPageListing();"
							...
							<img src="<?php echo plugins_url('includes/assets/', dirname(__FILE__)); ?>images/list.png" style="max-width:1.4vw"/>
						</button>
						<button class="btn btn-sm btn-outline-secondary" onclick="return showDashboard();"
							...
							<img src="<?php echo plugins_url('includes/assets/', dirname(__FILE__)); ?>images/dashboard.png" style="max-width:1.4vw"/>
						</button>
